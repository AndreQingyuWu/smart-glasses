...
#define BLE_UUID_NUS_TX_CHARACTERISTIC 0x0005                      /**< The UUID of the TX Characteristic. */
#define BLE_UUID_NUS_RX_CHARACTERISTIC 0x0006                      /**< The UUID of the RX Characteristic. */
